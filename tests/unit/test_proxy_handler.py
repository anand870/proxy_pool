...
class TestProxyHandlerGet:
    ...
    def test_get_returns_proxy(self):
        ...
        handler._mock_db.get.assert_called_once_with(https=False, residential=None)
    ...
    def test_get_https_forwarded(self):
        ...
        handler._mock_db.get.assert_called_once_with(https=True, residential=None)
...
class TestProxyHandlerPop:
    ...
    def test_pop_returns_proxy(self):
        ...
        assert result is not None
        assert result.proxy == "1.2.3.4:8080"
        handler._mock_db.pop.assert_called_once_with(https=False, residential=None)
